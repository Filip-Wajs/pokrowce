...
class Kamperp_m extends StatelessWidget {
  const Kamperp_m({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/kampery/przedsionek.jpg',),
        ),

        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/kampery/przedsionek1.jpg',),
        )
