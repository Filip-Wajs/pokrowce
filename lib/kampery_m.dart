...
class Kampery_m extends StatelessWidget {
  const Kampery_m({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/kampery/kamper2.jpg',),
        ),

        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/kampery/bus.jpg'),
        ),
