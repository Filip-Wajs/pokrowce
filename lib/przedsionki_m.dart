...
class Przedsionki_m extends StatelessWidget {
  const Przedsionki_m({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/przedsionki/straz1.jpg',),
        ),

        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Image.asset('assets/przedsionki/straz2.jpg'),
        ),
